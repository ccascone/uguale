...
def plot_file(test, stat, instance_name, new_folders, do_save):
    ...
    ax["gen"].grid(True)
    ticks_gen = [users[0]] + [""] * (int(len(users) / 2.0) - 1) + [users[int(len(users) / 2.0)]] + [""] * (
    int(len(users) / 2.0) - 1) + [users[-1]]
    ...
    if len(same_conns) == 1:
        ...
        ticks_gen = [conns_list[0]] + [""] * (int(len(conns_list) / 2.0) - 1) + [
            conns_list[int(len(conns_list) / 2.0)]] + [""] * (int(len(conns_list) / 2.0) - 1) + [conns_list[-1]]
    ...
    if len(same_rtts) == 1:
        ...
        ticks_gen = [rtts_list[0]] + [""] * (int(len(rtts_list) / 2.0) - 1) + [rtts_list[int(len(rtts_list) / 2.0)]] + [
                                                                                                                           ""] * (
                                                                                                                       int(
                                                                                                                           len(
                                                                                                                               rtts_list) / 2.0) - 1) + [
